	...
	internal class BxS_XLController
		{
				...
				internal BxS_XLController()
					{
						...
						//...
						//this._XLHndlr		= new Lazy<IExcel>				( ()=>	Globals.ThisAddIn.XLHndlr	, cz_LM )	;
			...
			#region "Declarations"
				...
				//...
				//private	readonly	Lazy<IExcel>					_XLHndlr	;
			...
			#region "Properties"
				...
				//...
				internal	IExcel	XLHndlr		{ get { return	Globals.ThisAddIn.XLHndlr; } }
				//...
