...
{
	public class ObjectPoolx<T> where T : IPoolObject
		{
			#region "Constructors"

				//¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨
				public ObjectPoolx(Func<T> newObjFnc		,
													int			max			= 10	,
													int			startup	= 5			)
					{
						this.Max					= max;
			...
			#region "Methods: Exposed"
				...
				//¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨
				public async Task<bool> PutObjectAsync(T ReturnedObject)
					{
						bool	lb_Ret = await Task.Run( () => ReturnedObject.ResetAsync() ).ConfigureAwait(false);
						//.............................................
						if (lb_Ret)		this._Objects.Add(ReturnedObject);
						else					Interlocked.Add(ref this._Count, -1);
						//.............................................
						return	lb_Ret;
					}
						...
						for (int i = 1; i <= this._Startup; i++)
							{
								...
								Interlocked.Add(ref this._Count, 1);
							}
					}
